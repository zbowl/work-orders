                ...
                <div class="hidden space-x-4 sm:flex sm:items-center sm:ml-6">
                    ...
                    <x-jet-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('admin.task') }}">
                                {{ __('Tasks') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('admin.status') }}">
                                {{ __('Statuses') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('admin.priority') }}">
                                {{ __('Priorities') }}
                            </x-jet-dropdown-link>
                            ...
                            <x-jet-dropdown-link href="{{ route('admin.sub-category') }}">
                                {{ __('Sub Categories') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>

                    <x-jet-nav-link href="{{ route('admin.configuration') }}" :active="request()->routeIs('admin.configuration')">
                        {{ __('Configuration') }}
                    </x-jet-nav-link>
                    {{--}}
